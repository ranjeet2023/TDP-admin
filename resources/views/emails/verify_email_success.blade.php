            ...
            <tr>
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" align="center" style="width:500px;background-color:rgb(255,255,255);border-radius:10px;padding:38px 45px 32px 35px;">
                        <tbody>
                            <tr>
                                <td style="padding:20px 0px 18px;letter-spacing:0.6px"><strong>Hi, {{ strip_tags($firstname) }} {{ strip_tags($lastname) }}</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding:18px 0px 0px;font-size:16px;letter-spacing:0.6px">
                                    Please wait while we review and approve your account. Once your account approved you able to do login.
                                </td>
                            </tr>
                            <tr>
