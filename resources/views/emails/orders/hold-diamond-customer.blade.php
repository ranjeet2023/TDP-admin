                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="font-size:16px;letter-spacing:0.6px">
                                    <p>Thank you for placing hold request.</p>
                                    <p>The details of your Hold diamonds can be found below:</p>
                                </td>
                            </tr>
                            <tr>
                                <td>{!! $text_message !!}</td>
                            ...
                            <tr>
                                <td style="padding:18px 0px 0px;font-size:16px;letter-spacing:0.6px">
                                    If you did not change your password, please contact our support team. Your security is very important to us!
                                </td>
                            </tr>
                            <tr>
