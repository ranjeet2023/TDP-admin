						...
						<div id="kt_content_container" class="container-xxl">
											...
											<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
												...
												<div class="d-flex flex-column">
													...
													<div class="d-flex align-items-center mb-2">
														<a class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $admin->companyname }}</a>
													</div>
													<div class="d-flex align-items-center mb-2">
														<a class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $admin->firstname.' '.$admin->lastname }}</a>
							...
							<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
								<div class="card-header cursor-pointer">
									...
									{{-- <a href="{{ url('admin-profile-edit')}}" class="btn btn-primary align-self-center">Edit Profile</a> --}}
								</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="row mb-7">
												...
												<div class="col-lg-8">
													<span class="fw-bolder fs-6 text-gray-800">{{ $admin->firstname.' '.$admin->lastname }}</span>
												</div>
											</div>
											<div class="row mb-7">
												<label class="col-lg-4 fw-bold text-muted">Contact Phone</label>
												<div class="col-lg-8">
													<span class="fw-bolder fs-6 text-gray-800">{{ $admin->mobile }}</span>
												</div>
											</div>
										</div>
