            ...
            <tr>
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" align="center" style="width:600px;background-color:rgb(255,255,255);border-radius:10px;padding:38px 45px 32px 35px;">
                        <tbody>
                            <tr>
                                <td style="padding:20px 0px 18px;letter-spacing:0.6px"><strong>Hi, {!! $customer !!}</strong></td>
                            </tr>
                            <tr>
                                <td style="font-size:16px;letter-spacing:0.6px">
                                    <p>You Have Not Checked The Cart Recently.</p>
                                    <p>Please Confirm the stone and checkout:</p>
                                </td>
                            </tr>
                            <tr>
                                <td>{!! $text_message !!}</td>
                            ...
                            <tr>
                                <td style="padding:10px 0px 0px;font-size:16px;letter-spacing:0.6px">
                                    If You need any help please contact Our Sales Team.
                                </td>
                            </tr>
                            <tr>
