                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-header border-0">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder text-dark">Natural Diamond</span>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#download_excel').click(function() {
                ...
                blockUI.block();
                request_call("{{ url('allStockDownload-natural')}}", searchdata + "&selected_stone=" + selected_stone+"&supplier_name=" + supplier_name);
            ...
            function go_my_search() {
                var searchdata = localStorage.getItem("search");
                blockUI.block();
                request_call("{{ url('diamond_natural_list')}}", "page=" + page_record_from + searchdata);
                xhr.done(function(mydata) {
                    blockUI.release();
            ...
            function loadMoreData(page){
                var searchdata = localStorage.getItem("search");
                blockUI.block();
                request_call("{{ route('diamond_natural_list') }}", "page=" + page +searchdata );
                xhr.done(function(mydata) {
                    blockUI.release();
                ...
                xhr.done(function(mydata) {
                    ...
                    if (mydata.success == true) {
                        $("#header-modal").html("<div class='modal-content' style='width: 513px;margin-left: 30%;margin-top:2%;'>" +
                            ...
                            "<h4 class='modal-title' style='text-align: center;'><strong>Stone Id : RK-" + certinumber + "</strong></h4>" +
                            "</div>" +
