...
<head>
    ...
    <title>Australian jewellery fair | Australian Jewelry Show | Australian Jewelry Registration | {{ config('app.name') }}.</title>
    <meta name="description" content="The biggest jewelry expo of the year is here, Australian Jewelry fair 2022, Las Vegas. Join the jewelry show to learn more about the prospects of the diamond industry." data-react-helmet="true">
    <meta name="keywords" content="{{ config('app.name') }}, diamonds, natural diamond, lab grown diamond, Australian Jewelry fair" />

    <link rel="canonical" href="https://{{ config('app.website') }}/australian-jewellery-fair" />
    <link rel="shortcut icon" href="{{ asset('assets/images/favicon.ico') }}">

    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Simplified B2B marketplace for diamonds | {{config('app.website')}}" />
						...
						<div class="row">
							<div class="col-md-6">
								<div class="banner-center-box text-white">
                                    <h1>Australian jewellery fair</h1>
									<h3>Australia</h3>
								...
								<div class="banner-center-box">
									<div class="cta-subscribe cta-subscribe-1 box-form text-center">
										<div class="box-title">
											...
											<p>Get australian jewellery fair registration link on your e-mail!</p>
										</div>
