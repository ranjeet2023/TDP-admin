            ...
            <tr>
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" align="center" style="width:500px;background-color:rgb(255,255,255);border-radius:10px;padding:38px 45px 32px 35px;">
                        <tbody>
                            <tr>
                                <td style="padding:20px 0px 18px;letter-spacing:0.6px"><strong>Hi, </strong></td>
                            </tr>
                            <tr>
                                <td style="font-size:16px;letter-spacing:0.6px">
                                    JCK is the place to go for order writing, motivational instruction, networking, entertainment, and a good time! JCK offers a customized experience that brings together a group that is creating the future of the jewelry industry. The Venetian Expo in Las Vegas, Nevada, will host JCK 2022 from June 10 to 13, 2022.
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:18px 0px 0px;font-size:16px;letter-spacing:0.6px">
                                    <a href="https://lasvegas.jckonline.com/en-us/register-to-attend.html">Click here to fill the registration form.</a>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:18px 0px 0px;font-size:16px;letter-spacing:0.6px">
                                    We, at The Diamond Port, b2b marketplace, hold a high reputation when it comes to online sale of diamonds. Be it supplier or buyer, we have always garnered huge appreciation for our services around the clock.
                                </td>
                            </tr>
                            <tr>
