                    ...
                    <div id="kt_content_container" class="container-xxl">
                        <div class="row gy-5 g-xl-8">
                            <div class="col-xl-12">
                                ...
                                @endif
                                <form role="form" method="post" action="{{ url('add-new-leads-post') }}" enctype="multipart/form-data" id="add_new_leads_post">
                                    @csrf
                                    <div class="card mb-3 gutter-b">
                                        <div class="card-header">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder fs-3">Add New Leads Form</span>
                                            </h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="row mb-5">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="additional_email" placeholder="Additional E-Mail">
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="additional_mobile_number" placeholder="Additional Mobile Number">
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                <div class="col-md-4">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="last_contacted" placeholder="Last Contacted">
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="associated_company" placeholder="Associated Company">
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                <div class="form-group mb-3 mt-3">
                                                    <button type="submit" class="ckditor btn btn-sm btn-primary">Add New Leads</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
