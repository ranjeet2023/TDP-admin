					...
					<div id="kt_content_container" class="container-xxl">
						<div class="card card-custom gutter-b">
                            <div class="card-header collapsible">
                                <h3 class="card-title">Unloaded Lab Grown</h3>
		...
		$(document).ready(function () {
			...
			$('.go_my_search').click(function (event) {
				...
				} else
				{
                    ...
                    blockUI.block();
                    request_call("{{ url('unloaded-lab-diamond')}}", searchdata);
                    xhr.done(function(mydata) {
                        blockUI.release();
            ...
            $("#movetosearch").click(function (event) {
                ...
                {
                    blockUI.block();
                    request_call("{{ url('movetosearch-labgrown')}}", "selected_stone=" + selected_stone);
                    xhr.done(function (mydata) {
                        blockUI.release();
                        swal({
                            title: "Success",
