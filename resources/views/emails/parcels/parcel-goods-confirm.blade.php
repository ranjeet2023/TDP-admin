                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="font-size:16px;letter-spacing:0.6px">
                                    <p>Please Place Order On your Enquiry Of Parcel Goods.</p>
                                    <p>The Price Of That Parcel Is :{{ $price }}</p>
                                </td>
                            </tr>
                            <tr>
                                <td>{!! $parceldetail !!}</td>
                            ...
                            <tr>
                                <td style="padding:18px 0px 0px;font-size:16px;letter-spacing:0.6px">
                                    The enquiry for that parcel Goods You Entered That's Price Has Updated,
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:18px 0px 0px;font-size:16px;letter-spacing:0.6px">
                                    Please Confirm The parcel and order It,
                                </td>
                            </tr>
                            <tr>
