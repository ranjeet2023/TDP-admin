                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="font-size:16px;letter-spacing:0.6px">
                                    Thank you for registering with {{config('app.name')}}. <br/> We are excited to have you on board!
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:18px 0px 0px;font-size:16px;letter-spacing:0.6px">
                                    {{config('app.name')}} makes it easier for the Wholesalers, Retailers & Value B2B customers like you  to buy Diamonds from around the globe with a click and fastest shipments from our nearest Port office.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding:18px 0px 0px;font-size:16px;letter-spacing:0.6px">
                                    You have received this email because you requested for registration with The diamonds port s web portal {{config('app.website')}} with this email address. If you did not intend to, you can ignore this email the account has not been created yet.
                                </td>
                            </tr>
                            <tr>
