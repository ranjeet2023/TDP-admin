                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 from_only" style="display: none;">
                                                <div class="x_content">
                                                    <form id="addclient" action="{{ url('post-pricesetting') }}" class="form-horizontal form-label-left" method="post" >
                                                        @csrf
                                                        <table class="table table-bordered ">
                                                            <?php
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="col-md-6">
                                                                        <input type="text" id="" value="<?php echo $value->pricechange ?>" name="<?php echo $value->price_id; ?>" required="required" class="form-control">
                                                                    </td>
                                                                </tr>
