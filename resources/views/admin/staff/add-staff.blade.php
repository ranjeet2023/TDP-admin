                    ...
                    <div id="kt_content_container" class="container-xxl">
                        <div class="row gy-5 g-xl-8">
                            <div class="col-xl-12">
                                ...
                                @endif
                                <form role="form" method="post" action="{{ url('post-add-staff') }}" id="supplier_detail">
                                    @csrf
                                    <div class="card mb-3 gutter-b">
                                        <div class="card-header">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder fs-3">Add New Member</span>
                                            </h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-3 col-sm-18">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select form-select-solid fw-bolder form-select-solid fw-bolder"
                                                            id="account_type" name="account_type">
                                                            <option value="1" {{ old('account_type')=='1' ? 'selected' : ''}}>Admin</option>
                                                            <option value="4" {{ old('account_type')=='4' ? 'selected' : ''}}>Sale</option>
                                                            <option value="5" {{ old('account_type')=='5' ? 'selected' : ''}}>Supplier</option>
                                                            <option value="6" {{ old('account_type')=='6' ? 'selected' : ''}}>Accountant</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-4 col-sm-18">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" name="email" placeholder="Enter Email Id" value="{{old('email')}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-5">
                                                <div class="col-md-4 col-sm-18">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="skype" placeholder="Enter Skype id" value="{{old('skype')}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-sm-18">
                                                    <div class="form-group">
                                                        <label for="salesperson">Marketing Email<span class='text-danger'>*</span></label>
                                                        <input type="email" class="form-control" name="marketingmail" placeholder="Enter Marketing Email" value="{{old('marketingmail')}}">
                                                    </div>
                                                </div>
                                                <div class="row mb-5">
                                                    <div class="col-md-4 col-sm-18">
