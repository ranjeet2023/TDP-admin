					...
					<div id="kt_content_container" class="container-xxl">
						<div class="row gy-5 g-xl-8">
							<div class="col-xl-12">
								...
								@endif
								<form role="form" method="post" action="{{ url('add-new-supplier')}}" enctype="multipart/form-data" id="supplier_detail">
									@csrf
									<div class="card mb-3 gutter-b">
										<div class="card-header">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder fs-3">Add Supplier</span>
											</h3>
										</div>
										<div class="card-body">
											<div class="row">
												...
												<div class="col-md-3 col-sm-18">
													<div class="form-group">
														<label for="salesperson">Password<span class='text-danger'>*</span></label>
											...
											<div class="row">
												<div class="col-md-6 col-sm-18">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="companyname"placeholder="Enter Valid Comany Name" >
													</div>
													<div class="form-group">
												...
												<div class="col-md-6 col-sm-18">
													<div class="form-group">Mobile<span class='text-danger'>*</span></label>
														<input type="tel" class="form-control input-phone" name="telphone" id="telphone" placeholder="Enter Number" >
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														<label for="title">Business registration number</label>
														<input type="text" class="form-control" name="compnay_registration_number" placeholder="Bussiness Document">
													</div>
													<div class="form-group">
														<label for="title">Business registration Document</label>
														<input type="file" class="form-control" name="compnay_registration_document" placeholder="Bussiness Document">

													</div>
													<div class="form-group">
														<label for="title">Director/partner Name </label>
														<input type="text" class="form-control" name="compnay_partner_name" placeholder="Partner Name" >
													</div>
													<div class="form-group">
														<label for="title">Director/partner Document</label>
														<input type="file" class="form-control" name="compnay_partner_document" placeholder="Bussiness Document" >
									...
									<div class="card mb-3 gutter-b">
										...
										<div class="card-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label for="title">Broker Name:</label>
														<input type="text" class="form-control" name="brokername">
													</div>
													<div class="form-group">
														<label for="title">Broker email:</label>
														<input type="email" class="form-control" name="brokeremail">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="title">Broker phone:</label>
														<input type="text" class="form-control" name="bokerphone" >
													</div>
												</div>
											</div>
										</div>
												...
												<div class="col-md-6 col-sm-18">
													<div class="form-group">
														...
														<select class="form-select form-select-solid fw-bolder upload_mode" id="upload_mode" name="upload_mode">
															...
															<option value="custom FTP" >custom FTP</option>
															<option value="custom API" >custom API</option>
														</select>
													</div>
													<div class="form-group mb-3 mt-3">
														<button type="submit" class="ckditor btn btn-sm btn-primary"> Add Suplier</button>
													</div>
												</div>
												<div class="col-md-6 col-sm-18">
