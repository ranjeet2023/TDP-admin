							...
							<div class="card-body">
								...
								<div class="row mb-2">
									<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<a id="Round" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Round" data-val="Round">
											<img class="image_off" src="{{asset('assets/images/shape/round.png')}}" width="25" alt="Round">
											<br>Round
										</a>
										<a id="Princess" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Princess" data-val="Princess">
											<img class="image_off" src="{{asset('assets/images/shape/princess.png')}}" width="25" alt="Princess">
											<br>Princess
										</a>
										<a id="Asscher" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Asscher" data-val="Asscher">
											<img class="image_off" src="{{asset('assets/images/shape/asscher.png')}}" width="25" alt="Asscher">
											<br>Asscher
										</a>
										<a id="Cushion" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Cushion" data-val="Cushion">
											<img class="image_off" src="{{asset('assets/images/shape/cushion.png')}}" width="25" alt="Cushion">
											<br>Cushion
										</a>
										<a id="Emerald" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Emerald" data-val="Emerald">
											<img class="image_off" src="{{asset('assets/images/shape/emerald.png')}}" width="25" alt="Emerald">
											<br>Emerald
										</a>
										<a id="Heart" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Heart" data-val="Heart">
											<img class="image_off" src="{{asset('assets/images/shape/heart.png')}}" width="25" alt="Heart">
											<br>Heart
										</a>
										<a id="Marquise" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Marquise" data-val="Marquise">
											<img class="image_off" src="{{asset('assets/images/shape/marquise.png')}}" width="25" alt="Marquise">
											<br>Marquise
										</a>
										<a id="Oval" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Oval" data-val="Oval">
											<img class="image_off" src="{{asset('assets/images/shape/oval.png')}}" width="25" alt="Oval">
											<br>Oval
										</a>
										<a id="Pear" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Radiant" data-val="Pear">
											<img class="image_off" src="{{asset('assets/images/shape/pear.png')}}" width="25" alt="Pear">
											<br>Pear
										</a>
										<a id="Radiant" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Radiant" data-val="Radiant">
											<img class="image_off" src="{{asset('assets/images/shape/radiant.png')}}" width="25" alt="Radiant"><br>Radiant
										</a>
										<a id="SQUARE_RADIANT" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="shape" data-val="SQUARE_RADIANT">
											<img class="image_off" src="{{asset('assets/images/shape/lradiant.png')}}" width="25" alt="SQUARE Radiant"><br>SQ.Radiant
										</a>
										<a id="TRILLIANT" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Trilliant" data-val="TRILLIANT">
											<img class="image_off" src="{{asset('assets/images/shape/trilliant.png')}}" width="25" alt="Trilliant"><br>Trilliant
										</a>
										<a id="CUSHION_MODIFIED" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Cushion" data-val="CUSHION_MODIFIED">
											<img class="image_off" src="{{asset('assets/images/shape/cushion.png')}}" width="25" alt="Cushion Modify"><br>Cushion mod.
										</a>
										<a id="Triangle" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="Triangle" data-val="Triangle">
											<img class="image_off" src="{{asset('assets/images/shape/triangle.png')}}" width="25" alt="Triangle"><br>Triangle
										</a>
										<a id="OTHER" class="btn btn-sm togglebtn shape border border-gray-300 p-2 fs-9" title="other" data-val="OTHER">
												...
												<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px ; padding-left: 0px;" >
													<div class="row">
														...
														<div class="col-md-10 col-sm-12 col-xs-12">
															<a id="intesites_Faint" class="btn togglebtn intensitydata ng-binding" title="Intensity" data-val="Faint" style="border: 1px solid #dcdcdc;">Faint</a>
															<a id="intesites_VeryLight" class="btn togglebtn intensitydata ng-binding" title="Intensity" data-val="VeryLight" style="border: 1px solid #dcdcdc;">Very Light</a>
															<a id="intesites_Light" class="btn togglebtn clarintensitydata ng-binding" title="Intensity" data-val="Light" style="border: 1px solid #dcdcdc;">Light</a>
															<a id="intesites_FancyLight" class="btn togglebtn intensitydata ng-binding" title="Intensity" data-val="FancyLight" style="border: 1px solid #dcdcdc;">Fancy Light</a>
															<a id="intesites_Fancy" class="btn togglebtn intensitydata ng-binding" title="Intensity" data-val="Fancy" style="border: 1px solid #dcdcdc;">Fancy</a>
															<a id="intesites_FancyDark" class="btn togglebtn intensitydata ng-binding" title="Intensity" data-val="FancyDark" style="border: 1px solid #dcdcdc;">Fancy Dark</a>
															<a id="intesites_FancyIntense" class="btn togglebtn intensitydata ng-binding" title="Intensity" data-val="FancyIntense" style="border: 1px solid #dcdcdc;">Fancy Intense</a>
															<a id="intesites_FancyVivid" class="btn togglebtn intensitydata ng-binding" title="Intensity" data-val="FancyVivid" style="border: 1px solid #dcdcdc;">Fancy Vivid</a>
															<a id="intesites_FancyDeep" class="btn togglebtn intensitydata ng-binding" title="Intensity" data-val="FancyDeep" style="border: 1px solid #dcdcdc;">Fancy Deep</a>
														</div>
													</div>
													<div class="row" style="padding-top: 10px;">
														...
														<div class="col-md-10 col-sm-12 col-xs-12">
															<a id="overtones_None" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="None" style="border: 1px solid #dcdcdc;">None</a>
															<a id="overtones_Yellow" class="btn togglebtn covertonedata ng-binding" title="Overtone" data-val="Yellow" style="border: 1px solid #dcdcdc;">Yellow</a>
															<a id="overtones_Yellowish" class="btn togglebtn covertonedata ng-binding" title="Overtone" data-val="Yellowish" style="border: 1px solid #dcdcdc;">Yellowish</a>
															<a id="overtones_Pink" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Pink" style="border: 1px solid #dcdcdc;">Pink</a>
															<a id="overtones_Pinkish" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Pinkish" style="border: 1px solid #dcdcdc;">Pinkish</a>
															<a id="overtones_Blue" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Blue" style="border: 1px solid #dcdcdc;">Blue</a>
															<a id="overtones_Blueish" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Blueish" style="border: 1px solid #dcdcdc;">Blueish</a>
															<a id="overtones_Red" class="btn togglebtn covertonedata ng-binding" title="Overtone" data-val="Red" style="border: 1px solid #dcdcdc;">Red</a>
															<a id="overtones_Reddish" class="btn togglebtn covertonedata ng-binding" title="Overtone" data-val="Reddish" style="border: 1px solid #dcdcdc;">Reddish</a>
															<a id="overtones_Green" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Green" style="border: 1px solid #dcdcdc;">Green</a>
															<a id="overtones_Greenish" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Greenish" style="border: 1px solid #dcdcdc;">Greenish</a>
															<a id="overtones_Purple" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Purple" style="border: 1px solid #dcdcdc;">Purple</a>
															<a id="overtones_Purplish" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Purplish" style="border: 1px solid #dcdcdc;">Purplish</a>
															<a id="overtones_Orange" class="btn togglebtn covertonedata ng-binding" title="Overtone" data-val="Orange" style="border: 1px solid #dcdcdc;">Orange</a>
															<a id="overtones_Orangey" class="btn togglebtn covertonedata ng-binding" title="Overtone" data-val="Orangey" style="border: 1px solid #dcdcdc;">Orangy</a>
															<a id="overtones_VIOLET" class="btn togglebtn covertonedata ng-binding" title="Overtone" data-val="VIOLET" style="border: 1px solid #dcdcdc;">Violet</a>
															<a id="overtones_Violetish" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Violetish" style="border: 1px solid #dcdcdc;">Violetish</a>
															<a id="overtones_Gray" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Gray" style="border: 1px solid #dcdcdc;">Gray</a>
															<a id="overtones_Grayish" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Grayish" style="border: 1px solid #dcdcdc;">Grayish</a>
															<a id="overtones_Black" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Black" style="border: 1px solid #dcdcdc;">Black</a>
															<a id="overtones_Brown" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Brown" style="border: 1px solid #dcdcdc;">Brown</a>
															<a id="overtones_Brownish" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Brownish" style="border: 1px solid #dcdcdc;">Brownish</a>
															<a id="overtones_Champagne" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Champagne" style="border: 1px solid #dcdcdc;">Champagne</a>
															<a id="overtones_Cognac" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Cognac" style="border: 1px solid #dcdcdc;">Cognac</a>
															<a id="overtones_Chameleon" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="Chameleon" style="border: 1px solid #dcdcdc;">Chameleon</a>
															<a id="overtones_White" class="btn togglebtn overtonedata ng-binding" title="Overtone" data-val="White" style="border: 1px solid #dcdcdc;">White</a>
															<a id="overtones_Other" class="btn togglebtn covertonedata ng-binding" title="Overtone" data-val="Other" style="border: 1px solid #dcdcdc;">Other</a>
														</div>
													</div>
													<div class="row" style="padding-top: 10px;">
														<div class="col-md-2 col-sm-12 col-xs-12 "style="vertical-align:middle;padding:5px">
														...
														<div class="col-md-10 col-sm-12 col-xs-12">
															...
															<a id="fcolor_Yellow" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Yellow" style="border: 1px solid #dcdcdc;">Yellow</a>
															<a id="fcolor_Pink" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Pink" style="border: 1px solid #dcdcdc;">Pink</a>
															<a id="fcolor_Blue" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Blue" style="border: 1px solid #dcdcdc;">Blue</a>
															<a id="fcolor_Red" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Red" style="border: 1px solid #dcdcdc;">Red</a>
															<a id="fcolor_Green" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Green" style="border: 1px solid #dcdcdc;">Green</a>
															<a id="fcolor_Purple" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Purple" style="border: 1px solid #dcdcdc;">Purple</a>
															<a id="fcolor_Orange" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Orange" style="border: 1px solid #dcdcdc;">Orange</a>
															<a id="fcolor_Violet" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Violet" style="border: 1px solid #dcdcdc;">Violet</a>
															<a id="fcolor_Grey" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Grey" style="border: 1px solid #dcdcdc;">Grey</a>
															<a id="fcolor_Black" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Black" style="border: 1px solid #dcdcdc;">Black</a>
															<a id="fcolor_brown" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="brown" style="border: 1px solid #dcdcdc;">Brown</a>
															<a id="fcolor_White" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="White" style="border: 1px solid #dcdcdc;">White</a>
															<a id="fcolor_Champagne" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Champagne" style="border: 1px solid #dcdcdc;">Champagne</a>
															<a id="fcolor_Cognac" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Cognac" style="border: 1px solid #dcdcdc;">Cognac</a>
															<a id="fcolor_Chameleon" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Chameleon" style="border: 1px solid #dcdcdc;">Chameleon</a>
															<a id="fcolor_Other" class="btn togglebtn FancyColordata ng-binding" title="FancyColor" data-val="Other" style="border: 1px solid #dcdcdc;">Others</a>
														</div>
													</div>
												</div>
											</div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-6">
                                        <a id="cut_ID" class="btn togglebtn btn-sm ID" style="border: 1px solid #dcdcdc;" title="cut" data-val="ID">Ideal</a>
                                        <a id="cut_EX" class="btn togglebtn btn-sm EX" style="border: 1px solid #dcdcdc;" title="cut" data-val="EX">Excellent</a>
                                        <a id="cut_VG" class="btn togglebtn btn-sm VG" style="border: 1px solid #dcdcdc;" title="cut" data-val="VG">Very Good</a>
                                        <a id="cut_GD" class="btn togglebtn btn-sm GD" style="border: 1px solid #dcdcdc;" title="cut" data-val="GD">Good</a>
                                        <a id="cut_FR" class="btn togglebtn btn-sm FR" style="border: 1px solid #dcdcdc;" title="cut" data-val="FR">Fair</a>
                                        <a id="cut_PR" class="btn togglebtn btn-sm PR" style="border: 1px solid #dcdcdc;" title="cut" data-val="PR">Poor</a>
                                    </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-10">
                                        <a id="polish_EX" class="btn togglebtn btn-sm EX" style="border: 1px solid #dcdcdc;" title="polish" data-val="EX">Excellent</a>
                                        <a id="polish_VG" class="btn togglebtn btn-sm VG" style="border: 1px solid #dcdcdc;" title="polish" data-val="VG">Very Good</a>
                                        <a id="polish_GD" class="btn togglebtn btn-sm GD" style="border: 1px solid #dcdcdc;" title="polish" data-val="GD">Good</a>
                                        <a id="polish_FR" class="btn togglebtn btn-sm FR" style="border: 1px solid #dcdcdc;" title="polish" data-val="FR">Fair</a>
                                        <a id="polish_PR" class="btn togglebtn btn-sm PR" style="border: 1px solid #dcdcdc;" title="polish" data-val="PR">Poor</a>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-1"><b>Symmetry</b></div>
                                    <div class="col-md-10">
                                        <a id="symmetry_EX" class="btn togglebtn btn-sm EX" style="border: 1px solid #dcdcdc;" title="symmetry" data-val="EX">Excellent</a>
                                        <a id="symmetry_VG" class="btn togglebtn btn-sm VG" style="border: 1px solid #dcdcdc;" title="symmetry" data-val="VG">Very Good</a>
                                        <a id="symmetry_GD" class="btn togglebtn btn-sm GD" style="border: 1px solid #dcdcdc;" title="symmetry" data-val="GD">Good</a>
                                        <a id="symmetry_FR" class="btn togglebtn btn-sm FR" style="border: 1px solid #dcdcdc;" title="symmetry" data-val="FR">Fair</a>
                                        <a id="symmetry_PR" class="btn togglebtn btn-sm PR" style="border: 1px solid #dcdcdc;" title="symmetry" data-val="PR">Poor</a>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-1"><b>Fluorescence</b></div>
                                    <div class="col-md-10">
                                        <a id="flourescence_NON" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="fluorescence" data-val="NON">NONE</a>
                                        <a id="flourescence_FNT" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="fluorescence" data-val="FNT">FAINT</a>
                                        <a id="flourescence_MED" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="fluorescence" data-val="MED">MEDIUM</a>
                                        <a id="flourescence_SLIGHT" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="fluorescence" data-val="SLIGHT">SLIGHT</a>
                                        <a id="flourescence_STG" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="fluorescence" data-val="STG">STRONG</a>
                                        <a id="flourescence_VST" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="fluorescence" data-val="VST">VERY STRONG</a>
                                        <a id="flourescence_VSLT" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="fluorescence" data-val="VSLT">VSLT</a>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-1"><b>Country</b></div>
                                    <div class="col-md-10">
                                        <a id="location_INDIA" class="btn togglebtn btn-sm" style="border: 1px solid #dcdcdc;" title="location" data-val="INDIA">INDIA</a>
                                        <a id="location_HONGKONG" class="btn togglebtn btn-sm" style="border: 1px solid #dcdcdc;" title="location" data-val="HONGKONG">HONG KONG</a>
                                        <a id="location_ISRAEL" class="btn togglebtn btn-sm" style="border: 1px solid #dcdcdc;" title="location" data-val="ISRAEL">ISRAEL</a>
                                        <a id="location_USA" class="btn togglebtn btn-sm" style="border: 1px solid #dcdcdc;" title="location" data-val="USA">USA</a>
                                        <a id="location_UAE" class="btn togglebtn btn-sm" style="border: 1px solid #dcdcdc;" title="location" data-val="UAE">UAE</a>
                                        <a id="location_BELGIUM" class="btn togglebtn btn-sm" style="border: 1px solid #dcdcdc;" title="location" data-val="BELGIUM">BELGIUM</a>
                                        <a id="location_OTHER" class="btn togglebtn btn-sm" style="border: 1px solid #dcdcdc;" title="location" data-val="OTHER">OTHER</a>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-1"><b>Lab</b></div>
                                    <div class="col-md-10">
                                        <a id="lab_GIA" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="lab" data-val="GIA">GIA</a>
                                        <a id="lab_IGI" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="lab" data-val="IGI">IGI</a>
                                        <a id="lab_HRD" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="lab" data-val="HRD">HRD</a>
                                        <a id="lab_AGS" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="lab" data-val="AGS">AGS</a>
                                        <a id="lab_GCAL" class="btn togglebtn btn-sm ng-binding" style="border: 1px solid #dcdcdc;" title="lab" data-val="GCAL">GCAL</a>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-1"><b>Eye Clean</b></div>
                                    <div class="col-md-10">
                                        <a id="eyeclean_YES" class="btn togglebtn btn-sm eyesyes" style="border: 1px solid #dcdcdc;" title="eyeclean" data-val="YES">YES</a>
                                        <a id="eyeclean_NO" class="btn togglebtn btn-sm eyesyes" style="border: 1px solid #dcdcdc;" title="eyeclean" data-val="NO">NO</a>
                                    </div>
                                </div>
                                <div class="row mb-2">
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			function count_stone() {
				...
				if (ptext != "")
				{
					request_call("{{ url('diamondcountnatural') }}", ptext);
				...
				$.confirm({
					...
					buttons: {
						confirm: function () {
                            ...
                            blockUI.block();
							request_call("{{ url('delete-stock-natural') }}", "company_name=" + company_name + "&stone_id=" + stone_id);
							xhr.done(function (mydata) {
                                blockUI.release();
								$.dialog({
									title: 'Successfully',
			...
			$('.go_my_search').click(function (event) {
				...
				{
					window.location.href = "diamond_natural_list";
				}
			});
